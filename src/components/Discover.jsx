  ...
  return (
    ...
    <Dialog as="div" className="relative z-50" initialFocus={cancelButtonRef} onClose={setOpen}>
      ...
      <div className="fixed inset-0 z-10 overflow-y-auto">
        <div className="flex pt-20 min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <Transition.Child
            as={Fragment}
            enter="ease-out duration-300"
          ...
          >
            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full max-w-lg lg:max-w-2xl">
            <div className="bg-white px-4 pb-4 pt-5 ">
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 ">
                    ...
                    <form>
                      <div className="flex items-center flex-wrap gap-1 lg:gap-3">
                        {[
                          "1000 Frs",
                          "2000 Frs",
                          "5000 Frs",
