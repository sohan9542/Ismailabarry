...
export let videos = [
  {
    ...
    description:
      "Dans cette vidéo nous allons vous replonger au début du 20ème siècle, depuis la création de la Société des Nations jusqu’à la création de l’ONU en passant par les différentes conférences.",
    videoUrl:
      "https://drive.google.com/file/d/1GVm-7j1BVyB2YSHoDOaT7qDITuvDY8ME/preview",
    progress: 0,
  ...
  },
  {
    ...
    description:
      "Voilà un sujet dialectique qui questionne encore l’intérêt de philosopher. Dans ce cas pratique, nous allons vous montrer pas à pas comment traiter ce genre de sujet et utiliser des illustrations pour appuyer vos propos.",
    videoUrl:
      "https://drive.google.com/file/d/1OMFS4CLAhikD6tkdWdNBnSlBnXveFO0U/preview",
    progress: 0,
  ...
  },
  {
    ...
    description:
      "L’Afrique étant un continent avec de nombreuses richesses, les occidentaux ont voulu se partager « le gâteau » et cela a conduit à plusieurs heurts, d’où la conférence de Berlin pour éviter des confrontations futures sur le sol Africain et les conséquences se ressentent jusqu’à présent sur le continent.",
    videoUrl:
      "https://drive.google.com/file/d/1dpt5WXYVIUsZy-iOzmAxR_TycOLdc8li/preview",
    progress: 0,
  ...
  },
  {
    ...
    description:
      "If I had Jangflix while at school, I would have done better… Après visionnage de cette vidéo, le conditionnel en anglais ne sera plus un secret pour vous. Le professeur va vous guider pas à pas avec des exemples concrets. ",
    videoUrl:
